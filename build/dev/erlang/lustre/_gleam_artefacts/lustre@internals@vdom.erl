...
-type element(QHY) :: {text, binary()} |
    {element,
        ...
        boolean()} |
    {map, fun(() -> element(QHY))} |
    {fragment, list(element(QHY)), binary()}.

-type attribute(QHZ) :: {attribute,
        binary(),
        gleam@dynamic:dynamic_(),
        boolean()} |
    {event,
        binary(),
        fun((gleam@dynamic:dynamic_()) -> {ok, QHZ} |
            {error, list(gleam@dynamic:decode_error())})}.

-spec attribute_to_event_handler(attribute(QJU)) -> {ok,
        {binary(),
            fun((gleam@dynamic:dynamic_()) -> {ok, QJU} |
                {error, list(gleam@dynamic:decode_error())})}} |
    {error, nil}.
...
-spec do_element_list_handlers(
    list(element(QIN)),
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, QIN} |
        {error, list(gleam@dynamic:decode_error())})),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, QIN} |
    {error, list(gleam@dynamic:decode_error())})).
...
-spec do_handlers(
    element(QIF),
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, QIF} |
        {error, list(gleam@dynamic:decode_error())})),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, QIF} |
    {error, list(gleam@dynamic:decode_error())})).
...
-spec handlers(element(QIA)) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok,
        QIA} |
    {error, list(gleam@dynamic:decode_error())})).
handlers(Element) ->
