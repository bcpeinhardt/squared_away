...
-spec map_response_body(
    fun((KHN) -> gleam@http@response:response(KGZ)),
    fun((KGZ) -> KHA)
) -> fun((KHN) -> gleam@http@response:response(KHA)).
...
-spec prepend_response_header(
    fun((KHR) -> gleam@http@response:response(KHT)),
    binary(),
    binary()
) -> fun((KHR) -> gleam@http@response:response(KHT)).
...
-spec ensure_post(gleam@http@request:request(KHE)) -> {ok,
        gleam@http@request:request(KHE)} |
    {error, nil}.
ensure_post(Req) ->
...
-spec method_override(fun((gleam@http@request:request(KJA)) -> KJI)) -> fun((gleam@http@request:request(KJA)) -> KJI).
