...
-spec push_key({ok, YUG} | {error, get_error()}, binary()) -> {ok, YUG} |
    {error, get_error()}.
push_key(Result, Key) ->
    case Result of
        {ok, T} ->
...
-spec expect_end_of_line(
    list(binary()),
    fun((list(binary())) -> {ok, {YWL, list(binary())}} | {error, parse_error()})
) -> {ok, {YWL, list(binary())}} | {error, parse_error()}.
...
-spec do(
    {ok, {YWW, list(binary())}} | {error, parse_error()},
    fun((YWW, list(binary())) -> {ok, YWZ} | {error, parse_error()})
) -> {ok, YWZ} | {error, parse_error()}.
do(Result, Next) ->
    case Result of
        {ok, {A, Input}} ->
            Next(A, Input);
...
-spec expect(
    list(binary()),
    binary(),
    fun((list(binary())) -> {ok, {YXE, list(binary())}} | {error, parse_error()})
) -> {ok, {YXE, list(binary())}} | {error, parse_error()}.
