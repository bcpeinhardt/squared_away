...
-type pool(OWY, OWZ) :: {pool,
        fun((glisten@internal@handler:loop_message(OWY), OWZ, glisten@internal@handler:connection(OWY)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(OWY), OWZ)),
        integer(),
        fun((glisten@internal@handler:connection(OWY)) -> {OWZ,
            gleam@option:option(gleam@erlang@process:selector(OWY))}),
        gleam@option:option(fun((OWZ) -> nil)),
        glisten@transport:transport()}.
