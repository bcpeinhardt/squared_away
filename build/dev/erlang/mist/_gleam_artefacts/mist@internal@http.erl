...
-spec add_date_header(gleam@http@response:response(VJK)) -> gleam@http@response:response(VJK).
...
-spec connection_close(gleam@http@response:response(VJN)) -> gleam@http@response:response(VJN).
...
-spec keep_alive(gleam@http@response:response(VJQ)) -> gleam@http@response:response(VJQ).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
-spec maybe_keep_alive(gleam@http@response:response(VJT)) -> gleam@http@response:response(VJT).
...
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(VJW)) -> gleam@http@response:response(VJW)).
